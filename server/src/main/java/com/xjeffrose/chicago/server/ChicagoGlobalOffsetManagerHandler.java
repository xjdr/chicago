...
public class ChicagoGlobalOffsetManagerHandler extends SimpleChannelInboundHandler<ChicagoMessage> {
  ...
  public ChicagoGlobalOffsetManagerHandler(Map<String, AtomicLong> offset,
